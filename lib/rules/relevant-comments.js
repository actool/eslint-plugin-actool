        ...
        scope.block.body.forEach((statement) => {
            ...
            if (!options.line.disabled) {
                ...
                innerComments.forEach((innerComment) => {
                    ...
                    if (options.line.by === "commit" && diffByCommits >= 1) {
                    ...
                    if (options.line.by === "days" && diffByDate >= 1) {
            ...
            if (!options.block.disabled) {
                ...
                // FIXME[#30]: diff will be specified later by options
                if (options.block.by === "commit" && diffByCommits >= 1) {
                ...
                if (options.block.by === "days" && diffByDate >= 1) {
