...
const meta = {
    ...
    docs: {
        description: "Limit TODO/FIXME tags amount in file",
        recommended: true,
        url: ruleDocUrl.replace("{{name}}", "max-tags"),
    },
    fixable: null,
    schema,
    messages: {
        // eslint-disable-next-line max-len, prettier/prettier
        [ERROR_MAX]: "At {{scope}} occured {{actual}} TODO/FIXME tags, but allowed only {{max}} (resolve or register)",
    },
};
